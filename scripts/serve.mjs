...
http.createServer((req, res) => {
  ...
  if (url.pathname === '/qa.js') {
    ...
    res.end(['partnership-checks.js', 'transport-checks.js', 'settings-checks.js', 'survival-checks.js', 'browser-qa.js', 'audio-qa.js', 'feelings-checks.js', 'feelings-browser.js'].map(file => fs.readFileSync(path.join(root, 'tests', file), 'utf8')).join('\n')); return;
  }
